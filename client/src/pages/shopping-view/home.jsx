...
function ShoppingHome() {
  ...
  // Use feature images if available, otherwise use fallback banners
  const bannerImages = featureImageList && featureImageList.length > 0 
    ? featureImageList 
    : fallbackBanners;
  ...
  useEffect(() => {
    if (bannerImages.length > 0) {
      ...
      }, 3500); // 3.5 seconds for automatic banner change
